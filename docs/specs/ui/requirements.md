...
- UI planning should happen through questions, sketches, and review before
  implementation.
...
- A right-side panel is optional and should only be used when it helps the
  current workflow.
- Mobile should use a simpler three-part structure: top context/account area,
  central work area, and bottom or compact primary navigation.
